...
def calcula_paises(poblaciones):
    ...
    '''
    #HACEMOS UN CONJUNTOS CON LOS PAISES
    n_paises = {nombre_pais for nombre_pais , _, _, _ in poblaciones}
    
    #TRANSFORMAMOS EL CONJUNTO EN LISTA PARA ORDENAR LOS ELEMENTOS
    n_paises = list(n_paises)
...
def filtra_por_pais(poblaciones, pais):
    ...
    '''
    filtro_pais = [(anyo, num_habitantes) for nombre_pais, cod_pais, anyo, num_habitantes in poblaciones if pais==nombre_pais or pais==cod_pais]
...
def filtra_por_paises_y_anyo(poblaciones, anyo, paises):
    ...
    '''
    filtro_pais_anyo = [(nombre_pais, num_habitantes) for nombre_pais, _, an, num_habitantes in poblaciones 
                    if anyo == an and nombre_pais in paises]
    
    return filtro_pais_anyo
##############################################################################################
